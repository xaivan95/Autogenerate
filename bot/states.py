...
class ProductStates(StatesGroup):
    ...
    waiting_for_delivery_discount_percent = State()
    ...
    # новое состояние для даты старта
    waiting_for_start_date = State()
    waiting_for_start_time = State()
    waiting_for_bag_type = State()      # Ожидание выбора вида сумки
    waiting_for_bag_gender = State()    # Ожидание выбора назначения
    waiting_for_bag_color = State()      #  ожидание выбора цвета
    waiting_for_bag_material = State()   #  ожидание выбора материала
